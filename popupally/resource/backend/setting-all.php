<div class="wrap">
<h2 style="display:none;">PopupAlly Settings</h2>
<?php settings_errors(PopupAlly::SETTING_KEY_ALL); ?>
<div id="popupally-import-wait-overlay">
	<img src="<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/wait.gif" alt="Importing" width="128" height="128" />
</div>
	...
	<tbody>
		...
		<tr>
			<td class="popupally-setting-left-col popupally-setting-tab-label-col <?php echo $setting['selected-tab']==='display'?'popupally-setting-tab-active':''; ?>" click-target=".selected-tab" click-value="display" tab-group="popup-tab-group-1" target="display" active-class="popupally-setting-tab-active">
				<div style="background-image: url('<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/display-icon.png');" class="popupally-tab-label">
					Display Settings
				</div>
			</td>
			<td rowspan="7" class="popupally-setting-content-cell popupally-setting-right-col">
				<div class="popupally-setting-content-container" style="display:<?php echo $setting['selected-tab']==='display'?'block':'none'; ?>;" popup-tab-group-1="display">
					<div class="popupally-option-setting-form" serialize-target="<?php echo esc_attr(PopupAllyDisplaySettings::SETTING_KEY_DISPLAY); ?>">
						<div class="popupally-load-setting-code" style="display:none"><?php PopupAllyDisplaySettings::show_display_settings(); ?></div>
					</div>
				</div>
				<div class="popupally-setting-content-container" style="display:<?php echo $setting['selected-tab']==='style'?'block':'none'; ?>;" popup-tab-group-1="style">
					<div class="popupally-option-setting-form" serialize-target="<?php echo esc_attr( PopupAllyStyleSettings::SETTING_KEY_STYLE); ?>">
						<div class="popupally-load-setting-code" style="display:none"><?php PopupAllyStyleSettings::show_style_settings(); ?></div>
					</div>
				</div>
					...
					<div class="popupally-setting-section">
						...
						<div class="popupally-setting-configure-block">
							<a href="https://popupally.com/upgrading-to-popupally-pro/" target="_blank">
								<img class="popupally-sample-image" src="<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/stats-sample.png" />
							</a>
						</div>
					</div>
				</div>
				<div class="popupally-setting-content-container" style="display:<?php echo $setting['selected-tab']==='split'?'block':'none'; ?>;" popup-tab-group-1="split">
					<div class="popupally-setting-section">
						...
						<div class="popupally-setting-configure-block">
							<a href="https://popupally.com/upgrading-to-popupally-pro/" target="_blank">
								<img class="popupally-sample-image" src="<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/split-test-sample.png" />
							</a>
						</div>
					</div>
				</div>
				<div class="popupally-setting-content-container" style="display:<?php echo $setting['selected-tab']==='advanced'?'block':'none'; ?>;" popup-tab-group-1="advanced">
					<div class="popupally-option-setting-form" serialize-target="<?php echo esc_attr(PopupAllyAdvancedSettings::SETTING_KEY_ADVANCED); ?>">
		...
		<tr>
			<td class="popupally-setting-left-col popupally-setting-tab-label-col <?php echo $setting['selected-tab']==='style'?'popupally-setting-tab-active':''; ?>" click-target=".selected-tab" click-value="style" tab-group="popup-tab-group-1" target="style" active-class="popupally-setting-tab-active">
				<div style="background-image: url('<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/style-icon.png');" class="popupally-tab-label">
					Style Settings
				</div>
			</td>
		</tr>
		<tr>
			<td class="popupally-setting-left-col popupally-setting-tab-label-col <?php echo $setting['selected-tab']==='stats'?'popupally-setting-tab-active':''; ?>" click-target=".selected-tab" click-value="stats" tab-group="popup-tab-group-1" target="stats" active-class="popupally-setting-tab-active">
				<div style="background-image: url('<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/stats-icon.png');" class="popupally-tab-label">
					Statistics
				</div>
			</td>
		</tr>
		<tr>
			<td class="popupally-setting-left-col popupally-setting-tab-label-col <?php echo $setting['selected-tab']==='split'?'popupally-setting-tab-active':''; ?>" click-target=".selected-tab" click-value="split" tab-group="popup-tab-group-1" target="split" active-class="popupally-setting-tab-active">
				<div style="background-image: url('<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/split-test-icon.png');" class="popupally-tab-label">
					Split Test
				</div>
			</td>
		</tr>
		<tr>
			<td class="popupally-setting-left-col popupally-setting-tab-label-col <?php echo $setting['selected-tab']==='advanced'?'popupally-setting-tab-active':''; ?>" click-target=".selected-tab" click-value="advanced" tab-group="popup-tab-group-1" target="advanced" active-class="popupally-setting-tab-active">
				<div style="background-image: url('<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/advanced-icon.png');" class="popupally-tab-label">
					Advanced Settings
				</div>
			</td>
		</tr>
		<tr>
			<td class="popupally-setting-left-col popupally-setting-tab-label-col <?php echo $setting['selected-tab']==='toolkit'?'popupally-setting-tab-active':''; ?>" click-target=".selected-tab" click-value="toolkit" tab-group="popup-tab-group-1" target="toolkit" active-class="popupally-setting-tab-active">
				<div style="background-image: url('<?php echo esc_attr(PopupAlly::$PLUGIN_URI); ?>resource/backend/img/toolbox-icon.png');" class="popupally-tab-label">
					Toolkit
				</div>
			</td>
		</tr>
		...
		<tr class="popupally-setting-last-row">
			...
			<td class="popupally-setting-right-col">
				<form class="popupally-option-submit-form" enctype="multipart/form-data" method="post" action="options.php">
					...
					<input type="hidden" name="<?php echo esc_attr(PopupAlly::SETTING_KEY_ALL); ?>[selected][selected-tab]" id="selected-tab" class="selected-tab popupally-update-follow-scroll" value="<?php echo esc_attr($setting['selected-tab']); ?>" />
					<input type="hidden" name="<?php echo esc_attr(PopupAlly::SETTING_KEY_ALL); ?>[<?php echo esc_attr(PopupAllyDisplaySettings::SETTING_KEY_DISPLAY); ?>]" class="<?php echo esc_attr(PopupAllyDisplaySettings::SETTING_KEY_DISPLAY); ?>" value="" />
					<input type="hidden" name="<?php echo esc_attr(PopupAlly::SETTING_KEY_ALL); ?>[<?php echo esc_attr(PopupAllyStyleSettings::SETTING_KEY_STYLE); ?>]" class="<?php echo esc_attr(PopupAllyStyleSettings::SETTING_KEY_STYLE); ?>" value="" />
					<input type="hidden" name="<?php echo esc_attr(PopupAlly::SETTING_KEY_ALL); ?>[<?php echo esc_attr(PopupAllyAdvancedSettings::SETTING_KEY_ADVANCED); ?>]" class="<?php echo esc_attr(PopupAllyAdvancedSettings::SETTING_KEY_ADVANCED); ?>" value="" />
